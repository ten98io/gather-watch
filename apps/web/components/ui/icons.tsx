/**
 * Inline SVG icon set (lucide path data, ISC) — replaces the emoji-as-icon
 * convention for controls. Icons inherit currentColor and size via props.
 * Keep this the single icon source; do not add an icon dependency.
 */
...
function base({ size = 16, ...rest }: IconProps): SVGProps<SVGSVGElement> {
  return {
    ...
    fill: 'none',
    stroke: 'currentColor',
    // 1.75 (refined from 2): lighter strokes stop icons out-shouting titles at
    // 16px inside buttons / 20px standalone (DESIGN.md §7).
    strokeWidth: 1.75,
    strokeLinecap: 'round',
...
export function StopCircleIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <circle cx="12" cy="12" r="10" />
      <rect width="6" height="6" x="9" y="9" rx="1" fill="currentColor" stroke="none" />
    </svg>
  );
}
...
export function PhoneOffIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      <path d="M13.832 16.568a1 1 0 0 0 1.213-.303l.355-.465A2 2 0 0 1 17 15h3a2 2 0 0 1 2 2v3a2 2 0 0 1-2 2A18 18 0 0 1 2 4a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v3a2 2 0 0 1-.8 1.6l-.468.351a1 1 0 0 0-.292 1.233" />
      <path d="m2 2 20 20" />
    </svg>
  );
}
